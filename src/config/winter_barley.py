...
PHENOLOGY_FILE_PATH   = os.path.join(ROOT_DATA_DIR, f"interim/phenology/{CROP}_phenology.csv")
...
static_features = ["soil_quality_mean","soil_quality_stdDev","elevation_mean","elevation_stdDev","slope_mean","slope_stdDev"]
